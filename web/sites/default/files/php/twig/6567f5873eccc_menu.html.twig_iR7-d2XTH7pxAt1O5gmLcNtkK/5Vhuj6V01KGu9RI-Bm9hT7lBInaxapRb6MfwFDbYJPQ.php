...
/* themes/lando_blog/templates/menu/menu.html.twig */
class __TwigTemplate_b26881f50820ae96ce184d421d92e901 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_menu_links($__items__ = null, $__attributes__ = null, $__menu_level__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 35
                    echo "      <div class=\"d-flex justify-content-center p-3 position-relative\" ";
      ...
      ";
        ...
        ";
            ...
            <div id=";
                    // line 41
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ("menu-link" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, true, 41), 41, $this->source)), "html", null, true);
                    echo " class=\"text-invisible menu-link\">
              ";
                    // line 42
    ...
    {
        return "themes/lando_blog/templates/menu/menu.html.twig";
    }
    ...
    {
        return array (  148 => 54,  143 => 51,  128 => 49,  122 => 46,  119 => 45,  117 => 44,  112 => 42,  108 => 41,  103 => 40,  85 => 39,  81 => 37,  75 => 35,  72 => 34,  69 => 33,  66 => 32,  51 => 31,  44 => 29,  41 => 24,  39 => 23,);
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <div class=\"d-flex justify-content-center p-3 position-relative\" {{ attributes }}>
      {% else %}
        <div class=\"d-flex justify-content-center p-3 position-relative\">
        {% endif %}
        {% for item in items %}
          <div class=\"col-1 text-center\" {{ item.attributes }}>
            <div id={{\"menu-link\" ~ loop.index0}} class=\"text-invisible menu-link\">
    ...
    {% endif %}
  {% endmacro %}
", "themes/lando_blog/templates/menu/menu.html.twig", "/app/web/themes/lando_blog/templates/menu/menu.html.twig");
    }
