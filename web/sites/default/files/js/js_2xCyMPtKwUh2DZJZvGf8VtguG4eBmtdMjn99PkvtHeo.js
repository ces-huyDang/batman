...
(function ($) {
  // Typewriter function
  // function typewriterEffect(elementId, text, interval) {
  ...
  //     $element.text(text.substring(0, currentPosition));
  //     currentPosition++;
  ...
  function getElementsPosition(elementId) {
    ...
    if (element) {
      ...
      // The rect object contains the element's position information
  ...
  $(document).ready(function () {
    // $(".thumbnail, .card-title").css("opacity", 0);
    // $(".thumbnail, .card-title").animate({ opacity: 1 }, 2000);

    for (let i = 0; i < postsLength; i++) {
      // typewriterEffect("#card-text" + i, $("#card-text" + i).text(), 1);
      getElementsPosition("card-text" + i);
    }
    ...
    $(window).scroll(function () {
      ...
      var element = document.getElementById("card-text4");

      // Define the animation threshold (adjust as needed)
      var animationThreshold = element.getBoundingClientRect().top;
      console.log(animationThreshold);
      console.log(scrollPosition);
      // Check if the scroll position is below the threshold
      if (scrollPosition >= animationThreshold) {
        // Add your animation logic here
        $("#card-text4").addClass("animated-class");
      } else {
        // Add logic for when the scroll position is above the threshold (optional)
        $("#card-text4").removeClass("animated-class");
      }
    });
  });
})(jQuery);
