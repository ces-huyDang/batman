...
(function ($) {
  ...
  function moviesBlock() {
    ...
    if (currentPath.startsWith("/vi", 0)) {
      ...
      newParent = $("<div></div>", {
        html: '<button class="btn btn-sm btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Movies</button>',
        id: originParent.attr("id"),
      });
    }
    originParent.replaceWith(newParent);
