...
(function ($) {
  ...
  function btnClick() {
    ...
    score.off("mouseout", mouseOut);
    score.off("mouseenter", mouseEnter);
    $(".rate-btn").prop("disabled", true);
    const confirmBtnGroup =
      '<div class="btn-group mt-3" role="group">' +
      '<button id="cancle" type="button" class="btn btn-light border border-dark">No</button>' +
  ...
  function cancel() {
    const score = $(".rate-btn");
    score.on("mouseout", mouseOut);
    score.on("mouseenter", mouseEnter);
