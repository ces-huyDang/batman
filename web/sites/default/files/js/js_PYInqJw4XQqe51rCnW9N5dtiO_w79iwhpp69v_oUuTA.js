...
(function ($) {
  function mouseEnter() {
    ...
    var scoreCircle =
      // '<div id="circle" class="circle row"><div class="score pt-2 text-center col-12">' +
      '<div id="score-circle">' + ratingScore + "</div>";
    // +"</div></div>";
    // if (parseInt(ratingScore) <= 3) {
  ...
  function mouseOut() {
    $("#rating-score").find("#score-circle").remove();
    console.log("out");
  }
