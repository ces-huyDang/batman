...
(function ($) {
  ...
  function language() {
    ...
    if (currentPath.startsWith("/vi", 0)) {
      newPath = currentPath.slice(2, currentPath.length);
      console.log(newPath);
      newParent = $("<div></div>", {
      ...
      dropdownMenu.append(
        '<li class="text-invisible chars-name"><a href="">Engish</a></li>'
      );
    } else {
      newParent = $("<div></div>", {
      ...
      dropdownMenu.append(
        '<li class="text-invisible chars-name"><a href="">Tiếng Việt</a></li>'
      );
    }
    originParent.replaceWith(newParent);
