...
(function ($) {
  ...
  $(window).scroll(function () {
    // Specify the ID of the element where you want to trigger the effect
    var targetElementId = "#yourTargetElement";

    // Check if the target element is in the viewport
    for (let i = 0; i < postsLength; i++) {
      if (isElementInViewport("#card-text" + i)) {
        // Trigger the typewriter effect when the target element is in the viewport
