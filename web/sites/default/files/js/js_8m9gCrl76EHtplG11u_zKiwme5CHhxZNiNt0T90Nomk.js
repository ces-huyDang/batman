...
(function ($) {
  Drupal.behaviors.myDropdown = {
    attach: function (context, settings) {
      ...
      var newParent = $(
        '<div class="dropdown" id="menu-link2"><span class="text-visible dropdown-menu" data-bs-toggle="dropdown" aria-expanded="false">Characters</span></div>',
        {
      ...
      var dropdownMenu = $('<ul class="dropdown-menu bg-dark"></ul>');
      $.ajax({
        url: "/characters",
