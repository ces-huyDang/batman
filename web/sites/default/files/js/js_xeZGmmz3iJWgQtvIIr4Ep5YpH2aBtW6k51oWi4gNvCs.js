...
(function ($) {
  function mouseEnter() {
    ...
    const hoverBtnColor = this.classList[1];
    const colorClass = hoverBtnColor.slice(12, hoverBtnColor.length);
    const newBgColor = "bg-" + colorClass;
    console.log(newBgColor);
    console.log(hoverBtnColor);
