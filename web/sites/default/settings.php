 ...
 * @endcode
 */
$settings['hash_salt'] = 'LhQ4edVXBpW-clFZVzxMVCh9MM_DNE-FEc0cDTTWrg1uTg5qkb4jvvEcaQh-bIeWOeSoOk1TJQ';
...
$settings['config_sync_directory'] = 'sites/default/files/config_opuvNeW4vPOqRzLoRqagKS9nebtUUO_cPWT-laFnUhdSrzYKyOAYSDJ28E6B8jZfwpgf7mvvjw/sync';

// Get the current request URI
$request_uri = $_SERVER['REQUEST_URI'];

// Check if the path starts with a specific string
